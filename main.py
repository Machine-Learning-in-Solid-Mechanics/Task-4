...
import core_naive_RNN_Naive as hc_n
import core_naive_RNN_FNN as hc_fnn
import core_naive_RNN_Gradient as hc_g
...
h = model.fit([eps, dts], [sig], epochs = 1500,  verbose = 2)
